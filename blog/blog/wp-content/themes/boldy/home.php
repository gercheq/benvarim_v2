	  ...
	  <div id="slider">
			...
			$page_data = get_page(get_option('boldy_slider'));
				...
				<div style="border:1px solid #ddd; text-align:center; padding:150px 100px 0; height:219px; font-size:14px;">
					Burası kayan bölme. Buraya ekleyeceğiniz sayfaya resim eklemelisiniz, bir diğer basit kural da link ayarlarını yapmalı ve yazı bölümü için başlık girmelisiniz. Daha sonra Tema Ayar Sayfasından "slider page" olarak bu sayfayı seçin. Eklediğiniz resmin boyutlarının 960px x 370px olduğundan emin olun.
				</div>
			<?php }?>
		</div>
	   ...
	   <!-- begin home boxes -->
		...
		<div id="homeBoxes" class="clearfix">
			<div class="homeBox">
				...
				<a href="<?php echo get_option('boldy_home_box1_link')?>"><strong>Devamını oku &raquo;</strong></a>
			</div>
			<div class="homeBox">
				<h2><?php echo $box2->post_title?></h2>
				<?php echo apply_filters('the_content', $box2->post_content);?>
				<a href="<?php echo get_option('boldy_home_box2_link')?>"><strong>Devamını oku &raquo;</strong></a>
			</div>
			<div class="homeBox last">
				<h2><?php echo $box3->post_title?></h2>
				<?php echo apply_filters('the_content', $box3->post_content);?>
				<a href="<?php echo get_option('boldy_home_box3_link')?>"><strong>Devamını oku &raquo;</strong></a>
			</div>
		</div>
		<?php }?>
		<!-- end home boxes -->
