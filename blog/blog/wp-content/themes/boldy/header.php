        ...
        <div id="header">
			...
			<div id="topSearch">
				<form id="searchform" action="<?php bloginfo('url'); ?>/" method="get">
					...
					<input type="text" id="s" name="s" value="arama yapın" />
				</form>
			</div>
			<!-- END TOP SEARCH -->
			...
			<div id="topSocial">
				<ul>
					...
					<li><a href="<?php echo get_option('boldy_linkedin_link'); ?>" class="linkedin" title="LinkedIn'de bize katılın!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_linkedin.png" alt="LinkedIn" /></a></li>
					<?php }?>
					<?php if(get_option('boldy_twitter_user')!=""){ ?>
					<li><a href="http://www.twitter.com/<?php echo get_option('boldy_twitter_user'); ?>" class="twitter" title="Twitter'da bizi takip edin!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_twitter.png" alt="Twitter'da bizi takip edin!" /></a></li>
					<?php }?>
					<?php if(get_option('boldy_facebook_link')!=""){ ?>
					<li><a href="<?php echo get_option('boldy_facebook_link'); ?>" class="twitter" title="Facebook'ta bize katılın!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_facebook.png" alt="Facebook'ta bize katılın!" /></a></li>
					<?php }?>
					<li><a href="<?php bloginfo('rss2_url'); ?>" title="RSS" class="rss"><img src="<?php bloginfo('template_directory'); ?>/images/ico_rss.png" alt="RSS Beslememize abone olun" /></a></li>
				</ul>
			</div>	
